...
void fill_buf_p(uint8_t *buf,uint16_t len, char PROGMEM *progmem_s)
{
        while (len){
...
//
#ifdef FLASH_VARS
void client_browse_url(char *urlbuf, char *urlbuf_varpart, char PROGMEM *hoststr, void (*callback)(uint8_t,uint16_t,uint16_t))
#else
...
#ifdef FLASH_VARS
void client_http_post(char PROGMEM *urlbuf, char PROGMEM *hoststr, char PROGMEM *additionalheaderline, char PROGMEM *method, char *postval,void (*callback)(uint8_t,uint16_t))
#else
void client_http_post(char PROGMEM *urlbuf, char PROGMEM *hoststr, char PROGMEM *additionalheaderline, char PROGMEM *method, char *postval,void (*callback)(uint8_t,uint16_t))
#endif
{
